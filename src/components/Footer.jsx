    ...
    <footer className="bg-gray-900 border-t border-gray-800 text-gray-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 lg:col-span-1">
            <div className="flex items-center gap-2 mb-6 text-white">
              ...
              <span className="text-2xl font-bold">سيارتك</span>
            </div>
            <p className="text-gray-400 mb-6 leading-relaxed">
              منصتك الأولى لخدمات صيانة السيارات المتنقلة في مصر. نقدم خدمات عالية الجودة في أي وقت وفي أي مكان.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#home" className="hover:text-primary-400 transition-colors">الرئيسية</a></li>
              <li><a href="#services" className="hover:text-primary-400 transition-colors">خدماتنا</a></li>
              <li><a href="#how-it-works" className="hover:text-primary-400 transition-colors">كيف نعمل</a></li>
              <li><a href="#pricing" className="hover:text-primary-400 transition-colors">الأسعار</a></li>
              <li><a href="#testimonials" className="hover:text-primary-400 transition-colors">آراء العملاء</a></li>
            </ul>
          </div>

          {/* Services Setup */}
          <div>
            <h3 className="text-white font-bold text-lg mb-6">أبرز الخدمات</h3>
            <ul className="space-y-4">
              <li><a href="#" className="hover:text-primary-400 transition-colors">تغيير البطارية</a></li>
              <li><a href="#" className="hover:text-primary-400 transition-colors">تغيير الزيت</a></li>
              <li><a href="#" className="hover:text-primary-400 transition-colors">خدمة الإطارات</a></li>
              <li><a href="#" className="hover:text-primary-400 transition-colors">خدمة الطوارئ</a></li>
              <li><a href="#" className="hover:text-primary-400 transition-colors">خدمة الونش</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex gap-3 items-start">
                ...
                <span>123 شارع الصيانة، المهندسين، القاهرة، مصر</span>
              </li>
              ...
              <li className="flex gap-3 items-center">
                ...
                <span>support@sayartak.com</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <p>جميع الحقوق محفوظة &copy; {new Date().getFullYear()} لمنصة سيارتك.</p>
          <div className="flex gap-4">
