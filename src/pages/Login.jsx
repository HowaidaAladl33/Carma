  ...
  return (
    <>
      ...
      <div className=" rounded-3xl shadow-2xl relative z-10 w-full flex flex-col lg:flex-row  h-auto mx-auto ">
        ...
        <div className="hidden lg:flex flex-col justify-between w-[48%] bg-primary-700 text-white p-12 relative overflow-hidden rounded-r-3xl m-4 ml-0 z-20">
          <div 
            className="absolute inset-0 opacity-100 z-0 pointer-events-none"
            style={{ backgroundImage: 'linear-gradient(126deg, #1e3a8a 0%, #1e3b8f 14%, #1e3c94 28%, #1e3d9a 42%, #1e3e9f 57%, #1e3ea4 71%, #1e3faa 85%, #1e40af 100%)' }}
          ></div>
          ...
          <div className="relative z-10">
            ...
            <p className="text-primary-100 text-lg leading-relaxed mb-12">
              احصل على خدمات صيانة السيارات أينما كنت. فريقنا جاهز لخدمتك على مدار الساعة.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={idx} className="flex gap-4 items-center bg-white/10 p-5 rounded-xl border border-white/5 backdrop-blur-sm">
                  <div className="bg-white/20 p-2.5 rounded-lg shrink-0">
                    <CheckCircle2 className="w-6 h-6 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-lg text-white mb-0.5">{feature.title}</h3>
          ...
          <div className="relative z-10 grid grid-cols-3 gap-6 pt-10 mt-10 border-t border-white/20 text-center">
            <div>
              ...
              <p className="text-primary-100 text-sm">تقييم ممتاز</p>
            </div>
            <div>
              <p className="text-3xl font-bold mb-1">50+</p>
              <p className="text-primary-100 text-sm">فني محترف</p>
            </div>
            <div>
              <p className="text-3xl font-bold mb-1">15K+</p>
              <p className="text-primary-100 text-sm">عميل سعيد</p>
            </div>
          </div>
        </div>
        ...
        <div className="shadow-xl border border-gray-200   rounded-l-3xl  relative z-10 w-full lg:w-[52%] m-4 mr-0 p-8 sm:p-12 lg:p-16 flex flex-col justify-center">
          ...
          <div className="text-center mb-10 ">
            <div className="inline-flex items-center  justify-center gap-2 mb-8 bg-gradient-to-r from-primary-800 to-primary-600 text-transparent bg-clip-text">
              <Car className="w-10 h-10 text-primary-600" />
              <div className="text-right">
                <h1 className="text-3xl font-bold text-primary-700">سيارتك</h1>
                <p className="text-gray-500 text-sm tracking-wide">خدمة صيانة السيارات</p>
              </div>
            </div>
          ...
          <form className="max-w-md w-full mx-auto space-y-6">
            ...
            {/* Role Selection */}
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-3 text-right">تسجيل الدخول كـ</label>
              <div className="flex gap-3 h-12">
                <button
                  type="button"
                  onClick={() => setRole('customer')}
                  className={`flex-1 rounded-xl text-sm font-medium transition-all ${role === 'customer' ? 'bg-primary-700 text-white border-primary-700 shadow-md' : 'bg-white text-gray-700 border border-gray-200 hover:bg-gray-50'}`}
                >
                  عميل
                </button>
                <button
                  ...
                  className={`flex-1 rounded-xl text-sm font-medium transition-all ${role === 'tech' ? 'bg-primary-700 text-white border-primary-700 shadow-md' : 'bg-white text-gray-700 border border-gray-200 hover:bg-gray-50'}`}
                >
                  فني
                </button>
                <button
                  ...
                  className={`flex-1 rounded-xl text-sm font-medium transition-all ${role === 'admin' ? 'bg-primary-700 text-white border-primary-700 shadow-md' : 'bg-white text-gray-700 border border-gray-200 hover:bg-gray-50'}`}
                >
                  مسؤول
                </button>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    placeholder={authMethod === 'phone' ? '01xxxxxxxxx' : 'example@mail.com'} 
                    dir="ltr"
                    className="block w-full pl-4 pr-11 py-3.5 border border-gray-200 rounded-xl focus:ring-primary-500 focus:border-primary-500 text-left bg-white text-gray-900 placeholder-gray-400 transition-colors focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    placeholder="••••••••" 
                    dir="ltr"
                    className="block w-full pl-11 pr-11 py-3.5 border border-gray-200 rounded-xl focus:ring-primary-500 focus:border-primary-500 text-left bg-white text-gray-900 placeholder-gray-400 transition-colors focus:outline-none"
                  />
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <input id="remember-me" type="checkbox" className="w-5 h-5 text-primary-600 border-gray-300 rounded focus:ring-primary-500" />
                <label htmlFor="remember-me" className="text-sm font-medium text-gray-700 select-none cursor-pointer">
                  تذكرني
                </label>
              </div>
              <a href="#" className="text-sm font-medium text-primary-800 hover:text-primary-600 transition-colors">
                نسيت كلمة المرور؟
              </a>
            </div>
            ...
            <button 
              type="submit" 
              className="w-full py-4 px-4 bg-primary-700 hover:bg-primary-800 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all"
            >
              تسجيل الدخول
            </button>
            ...
            <div className="grid grid-cols-2 gap-4">
              <button type="button" className="flex items-center justify-center gap-3 py-3 px-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
                <AppleIcon />
            ...
            <div className="text-center pt-2">
              <p className="text-gray-500">
                ليس لديك حساب؟{' '}
                <a href="#" className="font-bold text-primary-800 hover:text-primary-600 transition-colors">
                  سجل الآن
                </a>
              </p>
            </div>
